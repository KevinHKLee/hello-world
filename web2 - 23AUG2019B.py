    ...
    if int(btn1) > int(btn2) and int(btn1) > int(btn3):
        ...
        msg =   html.Div(
                    [ 
                                ...
                                dcc.Graph(
                                    ...
                                    figure=go.Figure(
                                        data=[
                                            ...
                                            go.Bar(
                                                x=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Period,
                                                y=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Low,
                                                # text=dfWY12CS.Low,
                                                textposition='auto',
                                            ...
                                            go.Bar(
                                                x=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Period,
                                                y=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Medium,
                                                name='Medium',
                                                # orientation = 'h',
                                                marker=go.bar.Marker(
                                                    color='yellow',
                                            ...
                                            go.Bar(
                                                x=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Period,
                                                y=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].High,
                                        ...
                                        layout=go.Layout(
                                            ...
                                            title=go.layout.Title(
                                                text=dfs1['Area'].unique()[i]+": Severity Trend",
                                                # xref="paper",
                                                x=0.1
                                            ),
                                            showlegend=True,
                                ...
                                dcc.Graph(
                                    ...
                                    figure=go.Figure(
                                        data=[
                                            ...
                                            go.Bar(
                                                x=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Period,
                                                y=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]]['Less than 4 weeks'],
                                                name='Less than 4 weeks',
                                                # orientation = 'h',
                                                marker=go.bar.Marker(
                                                    color='green',
                                            ...
                                            go.Bar(
                                                x=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Period,
                                                y=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]]['5 - 11 weeks'],
                                                name='5 - 11 weeks',
                                                # orientation = 'h',
                                                marker=go.bar.Marker(
                                                    color='yellow',
                                            ...
                                            go.Bar(
                                                x=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]].Period,
                                                y=dfs1[dfs1['Area']==dfs1['Area'].unique()[i]]['More than 12 weeks'],
                                                name='More than 12 weeks',
                                                # orientation = 'h',
                                                marker=go.bar.Marker(
                                                    color='red',
                                        ...
                                        layout=go.Layout(
                                            ...
                                            title=go.layout.Title(
                                                text=dfs1['Area'].unique()[i]+": Age of Finding Trend",
                                                # xref="paper",
                                                x=0
                                            ),
                                            showlegend=True,
                        ...
                        for i in range(0,dfs1['Area'].nunique())
                    ]
                )
